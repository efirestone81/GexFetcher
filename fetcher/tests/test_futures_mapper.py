...
def test_map_strike_methods_close_in_typical_case():
    ...
    # Set futures_ref_price so multiplier reflects realistic basis
    # (5800 with spot=580 → mult=10.0 implies a clean 1:10 with no basis).
    # In reality the multiplier would be slightly above 10 to absorb the basis.
    # For this test we just verify the order of magnitude is right.
